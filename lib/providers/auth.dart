...
class Auth with ChangeNotifier {
  ...
  Future<void> signup(String email, String password) async{
    final url = Uri.parse('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDxo9YXlTBGd6C2A6-Z3ucJo3p1CwYUS0w');
    try{
  ...
  Future <void> signin(String email,String password) async {
    final url = Uri.parse('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDxo9YXlTBGd6C2A6-Z3ucJo3p1CwYUS0w');
    try{
      final response = await http.post(url,body: json.encode(
          {
            'email': email,
